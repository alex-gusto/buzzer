      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex flex-wrap items-center gap-3 self-end">
            <CopyButton text={inviteLink} idleLabel="Copy invite" copiedLabel="Invite copied" />
            <CopyButton text={boardLink} idleLabel="Copy question board" copiedLabel="Board link copied" />
          </div>
        </div>
        <span className={`inline-flex items-center gap-2 self-start rounded-full px-4 py-2 text-sm font-medium ${statusClassName}`}>
